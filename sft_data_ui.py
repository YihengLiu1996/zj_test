...
# JSONL文件路径
JSONL_PATH = r"E:\大模型\之江实验室\第二期\jsonl_test.jsonl"  # 请修改为您的JSONL文件路径
...
def main():
    ...
    with st.sidebar:
        ...
        current_pos = valid_indices.index(
            st.session_state.current_index) + 1 if st.session_state.current_index in valid_indices else 1
